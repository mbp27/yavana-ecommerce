...
<div>
	<ul class="short" style="padding: 2em 0 0 3em;">
		...
		<li style="color:black;"> >
			<a href="{{ route('checkout.index') }}">Periksa</a>
		</li>
		<li style="color:black;"> >
...
<section id="payment" class="banner-bottom-wthreelayouts py-lg-5 py-3">
	<div class="container">
		<div class="inner-sec-shop px-lg-4 px-3">
			<h3 class="tittle-w3layouts my-lg-4 mt-3">Pembayaran</h3>
			<!--/tabs-->
			<div class="responsive_tabs">
				<div id="horizontalTab">
					<ul class="resp-tabs-list">
						<li>Bayar di Tempat (COD)</li>
						<li>Kredit/Debit</li>
						<li>Bank Internet</li>
					</ul>
					<div class="resp-tabs-container" style="width:75%">
						<!--/tab_one-->
						<div class="tab1">
							<div class="pay_info">
									...
									<div class="checkbox">
										<div class="check_box_one cashon_delivery">
											<label class="anim">
												...
												<span> Kami juga menerima kartu Kredit / Debit pada saat pengiriman. Silahkan periksa dengan agen.</span>
											</label>
										</div>
									...
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										<div class="credit-card-wrapper">
											<div class="first-row form-group">
												<div class="controls">
													<label class="control-label">Nama di Kartu</label>
